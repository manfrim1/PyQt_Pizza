...
class MyWindow(QWidget):
    ...
    def criar_widgets(self):
         # criar o layout horizontal onde os componentes irão ficar em formato de layout
        ...
        horizontalBox.addWidget(line_edit) 
        horizontalBox.addWidget(line_edit2)
        horizontalBox.addWidget(button)

        #passando o horizontal box de parametro para aparecer na tela.
